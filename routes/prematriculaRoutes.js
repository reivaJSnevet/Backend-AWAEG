...
prematriculaRouter.get('/prematriculas', prematriculaController.getAllPrematriculas);
prematriculaRouter.post('/prematriculas', prematriculaController.createPrematricula);
